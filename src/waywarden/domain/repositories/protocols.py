...
@runtime_checkable
class SessionRefRepository(Protocol):
    """Persist coding-session continuity references."""
    ...
    async def get(self, run_id: str, artifact_id: str) -> SessionReference | None: ...
    async def remove_by_run(self, run_id: str) -> int: ...
