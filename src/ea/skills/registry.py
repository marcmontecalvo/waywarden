from ea.skills.base import Skill
...
class SkillRegistry:
    ...
    def default(cls) -> "SkillRegistry":
        return cls(
            skills=[
                Skill("project_manager", "Tracks tasks, next steps, blockers, and priorities.", "default_chat"),
                Skill("inbox_triage", "Summarizes inbox and proposes replies.", "inbox_triage"),
                Skill("scheduler", "Understands calendar constraints and proposes scheduling actions.", "scheduler"),
                Skill("briefing", "Builds daily and weekly briefings.", "briefing"),
                Skill("coding_handoff", "Packages work for the external coding runtime.", "default_chat"),
                Skill("ha_gateway", "Routes approved requests to the external HA runtime.", "default_chat"),
            ]
        )
